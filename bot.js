...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexSiege = /^\/siege/; botRegexB = /^\/schedule/; botJohn = /^\/john/; botFaculty = /^\/faculty/;
      botSOS = /^\/sos/; 
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("current commands: /work /google /rtfm /sos /schedule /classchecks /directory /cool guy /faculty /shrug");
    this.res.end();
  }
